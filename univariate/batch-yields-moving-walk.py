...
h_ax2.set_xlim(0, N)
h_ax2.set_title('Batch viscosity for the past 5 years', fontsize=16)
h_ax2.set_ylabel('Motor oil viscosity [cP]', fontsize=16)
fig.savefig(outpath + 'batch-yields.png', dpi=96, facecolor='w', edgecolor='w',
        orientation='portrait', papertype=None, format=None,
        transparent=True)

np.savetxt(outpath + 'batch-yields-Python-simulation.dat', spike_walk)
plt.close()
