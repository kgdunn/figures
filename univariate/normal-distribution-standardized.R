...
x <- seq(-3.8, 3.8, 0.01)
px <- dnorm(x)
plot(x, px, type="l", xlab=(expression(""*x)), ylab="p(x)", frame.plot=FALSE, main=(expression("Normal distribution when "*mu*"=0 and "*sigma*"=1")), cex.lab=1.8, cex.main=1.8, lwd=2, cex.sub=1.8, cex.axis=1.8)
abline(v=0)
