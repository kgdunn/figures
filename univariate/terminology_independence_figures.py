...
def batch_yields(outdir: pathlib.Path) -> None:
    ...
    ax.set_title("Batch viscosity for the past 5 years", fontsize=16)
    ax.set_xlabel("Batch number (about one batch per day)", fontsize=14)
    ax.set_ylabel("Motor oil viscosity [cP]", fontsize=14)
