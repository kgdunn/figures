...
bitmap('snowfall-data.png', type="png256", width=12, height=7, res=250, pointsize=14) 
...
bitmap('temperature-data.png', type="png256", width=12, height=7, res=250, pointsize=14) 
