...
bitmap('2d-plot.png', type="png256", width=6.6665, height=6.6665, res=300, pointsize=14)
...
jpeg(file='board-thickness-3d-plot.png', height = 2000, width = 2000, quality=100, res=300)
cube(30)
dev.off()
