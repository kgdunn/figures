...
bitmap('residual-pattern-forgottern-term.png', type="png256", width=14, height=9, res=300, pointsize=14)
...
bitmap('residual-pattern-non-contant-error.png', type="png256", width=14, height=7, res=300, pointsize=14)
par(mar=c(4.2, 4.2, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
layout(matrix(c(1,2), 1, 2))
plot(x, y, type="p", cex.lab=1.5, cex.main=1.2, cex.sub=1.8, cex.axis=1.8, main="Raw data with the calculated least squares model")
abline(a=model$coefficients[1], b=model$coefficients[2])
...
model <- lm(y~x)
summary(model)
bitmap('residual-pattern-heavy-tails.png', type="png256", width=14, height=9, res=300, pointsize=14)
par(mar=c(4.2, 4.2, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
layout(matrix(c(1,2), 1, 2))
plot(x, y, type="p", cex.lab=1.5, cex.main=1.2, cex.sub=1.8, cex.axis=1.8, main="Raw data with the calculated least squares model")
abline(a=model$coefficients[1], b=model$coefficients[2])
...
x[5] = 32
model <- lm(y~x)
#bitmap('residual-strong-outliers.png', type="png256", width=14, height=9, res=300, pointsize=14)
par(mar=c(4.2, 4.2, 1.5, 0.5))  # (bottom, left, top, right); defaults are par(mar=c(5, 4, 4, 2) + 0.1)
layout(matrix(c(1,2), 1, 2))
plot(x, y, type="p", cex.lab=1.5, cex.main=1.2, cex.sub=1.8, cex.axis=1.8, main="Raw data with the calculated least squares model")
abline(a=model$coefficients[1], b=model$coefficients[2])
