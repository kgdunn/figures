...
text(0.5, 0.99, "1.0", col="darkgreen", cex=1)
...
acf(x, lag.max=14, ylab="Correlation values", main="Autocorrelation function", xlab="Lags")
text(0.5, 0.99, "1.0", col="darkgreen", cex=1)
text(1, 0.65, "0.61", col="darkgreen", cex=1)
text(2, 0.4, "0.35", col="darkgreen", cex=1)
text(3, 0.25, "0.19", col="darkgreen", cex=1)
text(4, 0.16, "0.11", col="darkgreen", cex=1)
dev.off()
