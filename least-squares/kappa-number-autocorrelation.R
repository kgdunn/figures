...
bitmap('kappa-number-autocorrelation.png', type="png256", width=14, height=14, res=300, pointsize=14)
...
bitmap('kappa-number-autocorrelation-scatterplots.png', type="png256", width=20, height=20/n.jumps, res=300, pointsize=14)
