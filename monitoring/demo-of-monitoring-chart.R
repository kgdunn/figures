...
bitmap('demo-of-monitoring-chart.png', type="png256", width=11, height=4, res=300, pointsize=14)
...
plot(ewma(data, lambda=lambda, target=base.mean), type="l", ylim=c(LCL*0.90, UCL*1.15), 
    xlab="Time sequence order", ylab="TC241 [degC]", main="Tank temperature, TC241 [degC]", 
