...
% Add a colour bar; use a perceptually uniform, colourblind-safe map
% (parula) rather than the rainbow hsv map. The committed PNG is now
% generated by chemical_reaction_contours.py (matplotlib, viridis).
colormap(parula)
axis equal
colorbar
